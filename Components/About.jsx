    ...
    return (
        <div className="about">
            ...
            <div className="aboutContent">
                <h1>Welcome to Tree-pad – Your Ultimate Tree-Structured Note-Taking Companion!</h1>
                <h2>At Tree-pad, we redefine the art of note-taking, offering you a dynamic and intuitive platform to organize your thoughts in a tree-like structure. With features designed for both simplicity and efficiency, Tree-pad empowers you to create intricate hierarchies of notes, making it easier than ever to manage complex projects or simply jot down your ideas in a structured manner.</h2>
                <h2>Key Features:</h2>
                <div className='aboutContentGrid'>
                    ...
                    <h3>6. User Accounts:</h3><h4>Register for a Tree-pad account to unlock the full potential of our app. Your notes will be securely stored in the cloud, accessible from any device, anywhere in the world. Your data is encrypted, ensuring the utmost privacy and security.</h4>
                    <h3>7. Google Login Integration:</h3><h4>Streamline your Tree-pad experience by logging in with your Google account. Connect seamlessly and securely to access your notes from any device. Your data remains encrypted, ensuring the utmost privacy and security.</h4>
                    <h3>8. Local Storage for Guest Users:</h3><h4>Not ready to create an account? No problem! Guest users can still enjoy the benefits of Tree-pad, with their files saved locally in the device's storage. Please note that these files won't be accessible from other devices.</h4>
                    <h3>9. Export as Word Doc:</h3><h4>Seamlessly export your meticulously organized notes as Word documents. Share your ideas, projects, or plans with others effortlessly.</h4>
                </div>
                <h2>Experience the convenience of structured note-taking with Tree-pad – where organization meets innovation. Sign up today to unlock a new level of productivity and creativity!</h2>
            </div>
        </div>
    )
}
